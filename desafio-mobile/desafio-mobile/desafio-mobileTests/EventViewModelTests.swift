...
final class EventViewModelTests: XCTestCase {
    ...
    func testEventSortingOrder() async {
        ...
        let movieLate = Event(id: "100", title: "Filme de Outubro", synopsis: nil, contentRating: nil, duration: nil, genres: nil, inPreSale: false, imageFeatured: nil, images: [], premiereDate: dateOct)
        let movieEarly = Event(id: "200", title: "Filme de Maio", synopsis: nil, contentRating: nil, duration: nil, genres: nil, inPreSale: false, imageFeatured: nil, images: [], premiereDate: dateMay)
